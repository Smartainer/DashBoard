...
const INITIAL_CONTAINER_OBJ = {
  ...
  slopex: Math.random() * 30,
  slopey: Math.random() * 30,
  slopez: Math.random() * 30,
  vibration: 0,
  port: "",
  wharf: "",
};
  ...
  const saveNewContainer = () => {
    if (containerObj.name.trim() === "")
      ...
      let newContainerObj = {
        ...
        slopex: parseFloat(containerObj.slopex),
        slopey: parseFloat(containerObj.slopey),
        slopez: parseFloat(containerObj.slopez),
